...
echo "--------------------"
echo "--------------------"
shallow_parser_ben < tests/shallowparser_ben_utf.rin > /tmp/out.tes
diff tests/shallowparser_ben_utf.rout /tmp/out.tes > /tmp/output.tmp
...
echo "Shallow Parser for Bengali version 3.0 installed successfully."
