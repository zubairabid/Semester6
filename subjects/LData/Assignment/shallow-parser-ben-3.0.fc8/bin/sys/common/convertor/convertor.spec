...
<ENV>$SHALLOW_PARSER_BEN=/home/setu/sampark
...
# convertor
1	convertor		$SHALLOW_PARSER_BEN/bin/sys/common/convertor/convertor_wx2utf_ssf_hin.sh	dep=<START>	intype=1	lang=sh
2	convertor		$SHALLOW_PARSER_BEN/bin/sys/common/convertor/convertor_wx2utf_text_hin.sh	dep=<START>	intype=1	lang=sh
3	convertor		$SHALLOW_PARSER_BEN/bin/sys/common/convertor/convertor_utf2wx_ssf_hin.sh	dep=<START>	intype=1	lang=sh
4	convertor		$SHALLOW_PARSER_BEN/bin/sys/common/convertor/convertor_utf2wx_text_hin.sh	dep=<START>	intype=1	lang=sh
